...
public class Empresas implements Serializable {
	...
	public List<Empresa> empresasParaImportacaoCriticidade() {

		return manager.createNamedQuery(Empresa.EMPRESASPARAIMPORTACAOCRITICIDADE,
				Empresa.class).getResultList();

	}
	public List<Empresa> empresasParaImportacaoAbc() {

		return manager.createNamedQuery(Empresa.EMPRESASPARAIMPORTACAOABC,
				Empresa.class).getResultList();

	}

	public List<Empresa> empresasParaCriticar() {

		return manager.createNamedQuery(Empresa.EMPRESASPARACRITICAR,
				Empresa.class).getResultList();
